#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To QURBAN
...
#Dev:QURBAN_YOUSAFZAK
##### LOGO #####
logo ="""
 \033[1;96m ------------------------
 \033[1;32m < OFFICIAL CODER QURBAN YOUSAFZAI >
 \033[1;96m ------------------------
\033[1;96m
  =====================================================
                    ASSALAMU ALAIKUM                    
            Coded By : QURBAN YOUSAFZAI      
                 Facebook : fb.com/qurban yousafzai               
            Youtube : youtube.com/Technical Wahab/Qurban    
                HACKING MASTER:QURBAN YOUSAFZAI     
     ---------------    ---------------    ------------  
                    Team YOUSAFZAI [ QURBII ]                     
  =====================================================
\033[1;32m _    _       __  __
 \033[1;32m╔═══╗╔╗─╔╗╔═══╗╔══╗─╔═══╗╔═╗─╔╗
\033[1;32m ║╔═╗║║║─║║║╔═╗║║╔╗║─║╔═╗║║║╚╗║║
...
print """
 \033[1;96m ------------------------
 \033[1;32m < QURBAN YOUSAFZAI >
 \033[1;96m ------------------------
\033[1;96m
  =====================================================
                    ASSALAMU ALAIKUM                    
            Created By : QURBAN YOUSAFZAI       
                 Facebook : fb.com/Qurban yousafzai                
            Youtube : youtube.com/Technical Wahab/Qurban     
                HACKER REWARD: Qurban No 1 In Pakistan Today         
    ---------------    ---------------    ------------  
                    Team Yousafzai [ Qurbii ]                     
  =====================================================
\033[1;97m
...
jalan("\033[1;96m---> \033[1;32mWelcome To My Hacking World")
jalan("\033[1;96m---> \033[1;32mIf You Have Any Problem You Can Contact Me On Facebook")
jalan("\033[1;96m---> \033[1;32mFacebook Page : facebook.com/Qurban yousafzai")
jalan("\033[1;96m---> \033[1;32mPakistani Famous Hacker Qurban")
jalan("\033[1;96m---> \033[1;32mPROUD TO BE A MUSLIM PROUD TO BE A YOUSAFZAI"")

jalan('\033[1;96m---> \033[1;32m TEAM YOUSAFZAI  \033[1;31m[   Qurban   ] ' )
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mACCESS GRANTED AS " + username #Dev:Qurban_yousafzai
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;31m---> \033[1;93mWarning: \033[1;31mEDITING MY SCRIPT WILL NOT MAKE YOU A QURBAN✅' ) 
		jalan(' \033[1;31m---> \033[1;96m IM NOT HARE TO PLAY THE GAME, IM HARE TO JUDGE THE PLAYERS ')
		jalan(' \033[1;32m---> \033[1;96m RESPECT YOUR BOSS, I MEAN RESPECT QURBAN YOUSAFZAI")
		jalan(' \033[1;97m--------------------------------------------------')
...
def menu():
	...
	print "\033[1;32m<-----\033[1;93mQURBAN㋡ UPGRADE QURBAN㋡\033[1;32m----->"
	print "\033[1;97m-------------------------------"
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;32m➥\033[1;32m1.\x1b[1;96mHack From Friend List."
	print "\033[1;32m➥\033[1;32m2.\x1b[1;96mHack Friend List Public ID."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;32m<-----\033[1;93mQURBAN • YOUR UNKNOWN ASS KICKER BROTHER OF YOUR UNKNOWN SISTER ㋡ QURBAN•YOUSAFZAI㋡\033[1;32m----->"
	...
	print "\033[1;32m<-----\033[1;93mQURBAN㋡ QURBAN•YOUSAFZAI㋡\033[1;32m----->"
	jalan(' \033[1;97m•••••••••••\033[1;93mCloning Start..\033[1;97m•••••••••• ')
	jalan(' \033[1;32m<-----\033[1;93mQURBAN㋡ QURBAN•YOUSAFZAI㋡\033[1;32m----->')
	jalan(' \033[1;97m-----------------------------------')
	...
	p = ThreadPool(50)
	p.map(main, id)
	print "\033[1;32m<-----\033[1;93mHack The World, Because Nothing Is Personal㋡ QURBAN YOUSAFZAI㋡\033[1;32m----->"
	print "  \033[1;93m<-----Developed By Qurban Yousafzai----->" #Dev:QURBAN YOUSAFZAI
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 hack.py)↩\033[1;97m....'
...
───╚╝╚═══╝╚╝╚═╝╚═══╝╚╝─╚╝╚╝─╚═╝
                       ...
                       Checkpoint ID Open After 2 Days

 Having Problem Contact Me On Facebook :www.facebook.com/Qurban yOusafzai"""
